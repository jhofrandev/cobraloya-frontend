  ...
  return (
    <>
      <div className="mx-auto max-w-screen-xl  py-2 px-2 sm:px-4 md:px-8 lg:px-12 xl:px-0">
        ...
        <div className="flex items-center mx-4 rounded-lg p-4 mb-8 bg-white dark:bg-gray-950">
        ...
        <div className="divide-y divide-gray-200 mb-8 dark:divide-gray-800 ">
          <div className="flex items-center mx-4 p-4 rounded-t-lg bg-white dark:bg-gray-950">
            <div className="flex-1">
              <h4 className="text-md font-medium text-gray-900 truncate dark:text-white">
                Cambiar contraseña
              </h4>
          ...
          <div className="flex items-center mx-4 p-4 rounded-b-lg bg-white dark:bg-gray-950">
            <div className="flex-1">
              <h4 className="text-md font-medium text-gray-900 truncate dark:text-white">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-800">
          ...
          <div className="flex items-center mx-4 p-4 bg-white dark:bg-gray-950">
            <div className="flex-1">
              <h4 className="text-md font-medium text-gray-900 truncate dark:text-white">
